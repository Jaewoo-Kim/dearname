...
const nextConfig = {
  ...
  // 사이드바 탭 통합(전환율 퍼널+AI 비용 → 분석, 팀 관리·감사 로그 → 운영 관리 하위)으로
  ...
  async redirects() {
    return [
      ...
      { source: '/audit-logs', destination: '/settings/audit-logs', permanent: true },
      { source: '/team', destination: '/settings/team', permanent: true },
      { source: '/team/audit-logs', destination: '/settings/audit-logs', permanent: true },
    ];
  },
};
