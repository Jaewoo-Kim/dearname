...
let TABOO_HANJA = new Set([
  // 사망·귀신·재앙 계열
  '死','鬼','亡','殺','邪','禍','毒','凶','惡',
  // 주검·요절 계열 (뜻이 '주검/시체/요절'인 한자 — 死와 같은 계열이나 누락돼 있었음)
  '尸','屍','歿','崩','喪','殉','夭','殞','斃','薨',
  '戮','冥','訃','殯','殲','骸',
  // 비천함·죄·고통 계열
  '賤','奴','罪','貧','苦','怨','恨','悲','哭','泣',
  '艱','慷','慨','困','窘','饑','惱','戇','悼','懣','悶','剝','煩','鄙',
  '猜','餓','怏','哀','隘','嗚','懊','冤','寃','嚚','凋','侄','慘','愴',
  '悽','慼','慽','痴','蚩','咤','殆','慟','痛','乏','悍','險','咻',
  // 위험·쇠락 계열
  '危','破','敗','廢','末','窮','孤','暗',
  // 신체·정신 결함 계열 (이름에 부적합한 한자)
  '盲','啞','癡','狂','愚','劣','醜','陋','拙',
  // 질병·신체손상 계열 (병·장애를 뜻하는 한자)
  '痂','癇','癎','疥','蹇','痼','畸','瘰','疸','痘','癩','癧','聾','瘻',
  '痲','眄','病','癬','瘙','痒','瘍','疫','瘟','癰','矮','萎','痳','疽',
  '癲','癤','腫','侏','疹','瘡','痔','跛','疱',
  // 흉악·재앙·저주 계열
  '咎','饉','殃','厄','災','詛','穽','呪','偪','逼','陷','兇','姦',
  // 간사·음란·거짓 계열
  '刧','劫','拐','狡','詭','伋','佞','躪','瞞','妄','誣','詐','慾','僞',
  '淫','剿','慝','騙','暴','虐','駻','噉','猾','獪','譎',
  // 모욕·착취 계열
  '辱','侮','欺','奸','賊','盜','掠','罵','蔑','狎','贓','竊','娼','偸'
]);
