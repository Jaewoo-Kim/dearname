...
아래 JSON 구조로 정확하게 반환해주세요 (각 필드의 분량 지침 준수):
{
  ...
  "careerAdvice": "이름의 역할 서사. 이 아이의 사주 원국에서 드러나는 타고난 방향성을 먼저 설명하고, 이 이름을 가짐으로써 사주의 부족한 기운이 어떻게 보완되어 어떤 인생 방향으로 나아가게 되는지를 3~4문장으로 서술하라. 오행·수리 근거를 녹여서 단순 나열이 아닌 이야기 형식으로 쓸 것. 마지막 문장은 미래에 대한 따뜻한 축원으로 마무리할 것.",
